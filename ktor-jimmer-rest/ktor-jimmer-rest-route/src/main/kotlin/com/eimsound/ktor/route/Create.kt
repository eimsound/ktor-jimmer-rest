...
inline fun <reified TEntity : Any> Route.create(
    ...
    val result = when (input) {
        is Inputs.Entity -> {
            ...
            sqlClient.save(entity, SaveMode.INSERT_ONLY, AssociatedSaveMode.MERGE)
        }
...
interface CreateProvider<T : Any> : CallProvider, InputProvider<T>, ValidatorProvider<T>, TransformProvider<T>
